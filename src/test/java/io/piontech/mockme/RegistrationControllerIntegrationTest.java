...
@SpringBootTest(classes = { MockmeApplication.class, TestDbConfig.class, TestIntegrationConfig.class }, webEnvironment = WebEnvironment.RANDOM_PORT)
@Transactional
public class RegistrationControllerIntegrationTest {
    ...
    public void setUp() {
        ...
        User user = new User();
        user.setEmail(UUID.randomUUID().toString() + "@yahoo.com");
