...
import io.piontech.mockme.account.persistence.dao.DeviceMetadataRepository;
import io.piontech.mockme.account.persistence.dao.UserRepository;
import io.piontech.mockme.account.persistence.domain.DeviceMetadata;
...
@SpringBootTest(classes = {MockmeApplication.class, TestDbConfig.class, TestIntegrationConfig.class}, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
